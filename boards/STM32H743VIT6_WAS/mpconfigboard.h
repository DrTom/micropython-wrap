...
#define MICROPY_HW_I2C4_SCL (pin_B6) // B6,B8,D12,F14
#define MICROPY_HW_I2C4_SDA (pin_B7) // B7,B9,D13,F15
...
#define MICROPY_HW_SPI2_NSS  (pin_A11) // A11,B4,B9,B12
#define MICROPY_HW_SPI2_SCK  (pin_B10) // A9,A12,B10,B13,D3
